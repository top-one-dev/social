...
namespace :repo do
  ...
  #   # contact us directly at legal@goji.live with any questions about the
  #   # contributors to Goji.live.
  # end
  ...
  #               response = HTTP.headers('Authorization' => "token #{ENV['GITLAB_API_TOKEN']}").get("https://api.gitlab.com/repos/goji-live/goji-social/pulls/#{pull_request_number}")
