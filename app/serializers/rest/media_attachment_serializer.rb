...
class REST::MediaAttachmentSerializer < ActiveModel::Serializer
  ...
  def clean_migrated_url
    object
      .file_file_name
      .sub("gab://media/", "")
      .gsub("https://gabfiles.blob.core.windows.net/", "https://goji.live/media/")
      .gsub("https://files.goji.live/file/files-gab/", "https://goji.live/media/")
      .gsub("https://f002.backblazeb2.com/file/files-gab/", "https://goji.live/media/")
      .split("|")
  end
