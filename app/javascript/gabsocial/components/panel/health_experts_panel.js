...
const messages = defineMessages({
  ...
  text: { id: 'account.health_experts.text_sm', defaultMessage: 'Apply for an Expert tag, which ensures your posts show up under the Goji Expert feed. Help us promote your good work.' },
