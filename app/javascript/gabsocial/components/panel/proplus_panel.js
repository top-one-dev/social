...
const messages = defineMessages({
  title: { id: 'promo.goji_proplus', defaultMessage: 'Upgrade to GojiProPlus' },
  text: { id: 'pro_upgrade_modal.text_sm', defaultMessage: 'Access expanded video, reach, ads and more with Goji ProPlus. Designed for health experts and content creators.' },
})
