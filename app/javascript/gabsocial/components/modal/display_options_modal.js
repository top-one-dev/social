...
const messages = defineMessages({
  message: { id: 'display_options.message', defaultMessage: 'Display settings affect your Goji.live account on this browser. These settings are only visible to you.' },
