...
const messages = defineMessages({
  ...
  healthExpertApplication: { id: 'health_expert_application', defaultMessage: ' sent the join request as Goji Health Expert' },
  healthExpertApprove: { id: 'health_expert_approve', defaultMessage: 'Congratulations! Your application to join as a Goji Health Expert has been approved. New posts you make will show up on our Expert Feed.' },
