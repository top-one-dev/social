...
export const APP_NAME = 'Goji.live'
...
export const URL_GAB_PRO = 'https://goji.network'
export const URL_GAB_PRO_LEARN_MORE = 'https://goji.network'
export const URL_GAB_PRO_UPGRADE = 'https://goji.network/goji-health-network-pricing/'
