      ...
      <div className={[_s.default].join(' ')}>
        <Block>
          <div className={[_s.default, _s.px15, _s.py15].join(' ')}>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>GOJI NETWORK INC (”Company” or “We”) respect your privacy and are committed to protecting it through our compliance with this policy.</Text>

            <Text tagName='p' className={_s.mt15} size='medium'>
              This policy describes the types of information we may collect from you or that you may provide when you visit the websites goji.live, and goji.news, and any other online properties of Goji Network Inc (each a “Website”) and our practices for collecting, using, maintaining, protecting, and disclosing that information.
            </Text>
            ...
            <ul className={[_s.default, _s.px15, _s.mt15, _s.ml15].join(' ')}>
              ...
              <li className={_s.mt10}>
                <Text tagName='p' size='medium'>If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of Goji Network Inc, our employees, our customers, or any other person.</Text>
              </li>
            </ul>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>You may also send us an email at support [at] goji [dot] live to request access to, correct or delete any personal information that you have provided to us. We cannot delete your personal information except by also deleting your user account. We may not accommodate a request to change information if we believe the change would violate any law or legal requirement or cause the information to be incorrect.</Text>
            <Text tagName='p' className={_s.mt15} size='medium'>
