      ...
      <div className={[_s.default].join(' ')}>
        <Block>
          <div className={[_s.default, _s.px15, _s.py15, _s.mb10].join(' ')}>
            <Heading>About Goji.live</Heading>

            <Text tagName='p' className={_s.mt15} size='medium'>
              Goji.live is the social network for Goji Network (https://goji.network), launched to create a safe,
          ...
          <div className={[_s.default, _s.px15, _s.py15].join(' ')} id='opensource'>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>
              ...
              <Button
                ...
                href='https://gitlab.com/goji-live/goji-social'
              >
                https://gitlab.com/goji-live/goji-social
              </Button>
            </Text>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>
              ...
              <Button
                ...
                backgroundColor='none'
                className={_s.displayInline}
                href='https://goji.live/about/tos'
              >
                https://goji.live/about/tos
              </Button>
              .
            </Text>
          </div>
