      ...
      <div className={[_s.default].join(' ')}>
        <Block>
          <div className={[_s.default, _s.px15, _s.py15].join(' ')}>
            <Heading>GOJI NETWORK INC</Heading>
            <br />
            <Heading>Terms of Sale</Heading>
            <Heading size='h4'>Last Updated: 20 July 2020</Heading>
            <br />

            <Text tagName='p' className={_s.mt15} size='medium'>Goji Network Inc (“We” or “Goji.live”) hereby allow you to access certain premium features or content in exchange for a one-time or recurring fee, as applicable to the relevant features or content, such as our “GojiPro/GojiProPlus” enhanced social media offering, our Goji Shop, or Goji.live webinar or teleconferencing service (each a “Paid Service” and collectively the "Paid Services"). Your transactions and any other use of the Paid Services are subject to these Goji.live Paid Service Terms of Sale ("Terms”).</Text>

            <br />
            <Heading size='h2'>1. Your Acceptance</Heading>

            <Text tagName='p' className={_s.mt15} size='medium'>
              By using a Paid Service, you signify your agreement to (1) these Terms of Sale; and (2) Goji Network Inc’s&nbsp;
              <Button
                isText
                underlineOnHover
                color='brand'
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>Goji.live accepts payment via the current payment method indicated prior to purchase, which may include Bitcoin and/or any other form of payment that we make available to you from time to time. You must tender valid payment or have a valid accepted form of payment on file in order to purchase Paid Services. You agree to abide by any relevant Terms of Service or other legal agreement, whether with Goji.live or a third party, that governs your use of a given payment processing method. Prices for any Paid Service may change at any time, and Goji.live does not provide price protection or refunds in the event of a price reduction or promotional offering. You agree to pay for any Paid Service that you order. Goji.live will charge your credit card or other form of payment for the price listed on the relevant Paid Service offer, along with any additional amounts relating to applicable taxes, bank fees and currency fluctuations. If you purchase any automatically renewing subscriptions, you agree that Goji.live will charge the payment method on file on the first day of each billing period for the relevant subscription, and if the payment method on file becomes invalid due to an expired credit card or other similar reason and we are unable to charge you on the next billing period, Goji.live reserves the right to immediately revoke your access to any Paid Service you have ordered until you update your payment method. If you fail to update your payment method within a reasonable amount of time, Goji.live may cancel your subscription.</Text>
            ...
            <ul className={[_s.default, _s.px15, _s.mt15, _s.ml15].join(' ')}>
              ...
              <li className={_s.mt10}>
                <Text tagName='p' size='medium'>circumvent, reverse-engineer, modify, disable, or otherwise tamper with any security technology that Goji.live uses to protect the Paid Service or encourage or help anyone else to do so;</Text>
              </li>
              <li className={_s.mt10}>
                <Text tagName='p' size='medium'>access the Paid Service other than by means authorized by Goji.live; or</Text>
              </li>
              <li className={_s.mt10}>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>Goji.live reserves the right to change the availability and content of the Paid Services at any time with or without notice to you. In addition, we reserve the right to modify, suspend, or discontinue any Paid Service with or without notice to you and we will not be liable to you or any third party for any such modifications, suspension, or termination. However, this will not affect your ability to request a refund as described above.</Text>
            <Text tagName='p' className={_s.mt15} size='medium'>
              In certain cases, content available within a Paid Service may become unavailable. Goji.live will have no liability to you for any such unavailability. We may also change these Paid Service Terms from time to time so we encourage you to periodically review the most up-to-date version at&nbsp;
              <Button
                isText
                underlineOnHover
                color='brand'
