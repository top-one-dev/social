  ...
  render() {
    return (
      <div className={[_s.default, _s.width100PC, _s.height100PC].join(' ')}>
        <Image src='/headers/onboarding.png' alt='Welcome to Goji.live' />

        <div className={[_s.default, _s.px15, _s.py15].join(' ')}>

          <Text size='large'>Goji.live is a place for online health freedom and knowledge sharing. </Text>
          <br />
          <Text size='large'>Goji.Live is a free, secure, private portal for the wellness community, a place to gather, talk health, and organize. </Text>
          <br />
      ...
      <div className={[_s.default, _s.width100PC].join(' ')}>
        <div className={[_s.default, _s.py15, _s.alignItemsCenter].join(' ')}>
          <div className={[_s.default, _s.px15, _s.mb15].join(' ')}>
            <Text size='large'>Goji.live Groups are a great way to connect with people who share your interests. Please select a few groups to get started.</Text>
          </div>
        ...
        <div className={[_s.default, _s.py15, _s.px15].join(' ')}>
          {
            !submitted &&
            <Fragment>
              <Text size='large' className={_s.pb10}>Now let's make your very first Goji.live post! Please introduce yourself to the Goji.live community. How did you hear about Goji.live? What are you interested in?</Text>
              <br />
