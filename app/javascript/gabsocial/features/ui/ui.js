...
const messages = defineMessages({
  beforeUnload: { id: 'ui.beforeunload', defaultMessage: 'Your draft will be lost if you leave Goji.live.' },
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <WrappedRoute path='/timeline/trends' exact page={TrendsPage} component={TrendsTimeline} content={children} componentParams={{ title: 'Goji News' }} />
